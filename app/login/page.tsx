      ...
      <div className="flex flex-col justify-center bg-white px-6 py-12 md:px-16 md:py-16">
        <div className="mx-auto w-full max-w-[380px]">
          ...
          <button
            ...
            className="mb-6 flex w-full cursor-pointer items-center justify-center gap-2.5 rounded-lg border border-[var(--gray-200)] bg-white px-4 py-3.5 text-[15px] font-medium text-[var(--gray-700)] transition-colors hover:bg-[var(--gray-50)] hover:border-[#d1d1d1] focus:border-[var(--maroon-900)] focus:outline-none focus:ring-[3px] focus:ring-[var(--maroon-100)] disabled:opacity-60"
          >
          ...
          <div className="flex items-center gap-4 py-6 text-[13px] text-[var(--gray-400)]">
          ...
          <div className="mt-6 border-t border-[var(--gray-100)] pt-6 text-center">
            <Link
              href="/opportunities"
              className="text-sm text-[var(--gray-500)] no-underline transition-colors hover:text-[var(--maroon-900)]"
            >
